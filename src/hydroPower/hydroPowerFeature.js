...
function markup() {
  return `<div class="mn-hydro-backdrop" data-hydro-modal hidden><section class="mn-hydro-panel">
    <header><div><small>ЭНЕРГЕТИЧЕСКОЕ ПРЕДПРИЯТИЕ</small><h2>Гидроэлектростанция</h2><p>Турбины у воды → генерация → накопитель → ЛЭП → подстанции</p></div><button data-hydro-close aria-label="Закрыть">×</button></header>
