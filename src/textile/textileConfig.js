...
export const TEXTILE_PRODUCTS = Object.freeze(Object.values(TEXTILE_RECIPES).filter(Boolean).map((item) => Object.freeze({
...
export const TEXTILE_PRODUCT_BY_TYPE = Object.freeze(Object.fromEntries(TEXTILE_PRODUCTS.filter(Boolean).map((item) => [item.itemType, item])));
export const TEXTILE_RAW_BY_TYPE = Object.freeze(Object.fromEntries(TEXTILE_RAW_ITEMS.filter(Boolean).map((item) => [item.itemType, item])));
