...
export function getTextileError(error) {
  ...
  const messages = {
    ...
    INDUSTRY_PRODUCT_UNSUPPORTED: 'Этот товар не поддерживается выбранным магазином.', INDUSTRY_OFFER_NOT_FOUND: 'Партия уже продана или снята с биржи.',
    INDUSTRY_REQUEST_NOT_FOUND: 'Заказ уже выполнен или снят с биржи.', BUSINESS_CASH_NOT_ENOUGH: 'На счёте выбранного магазина недостаточно денег.',
    BUSINESS_FINANCE_NOT_FOUND: 'Не найден финансовый счёт выбранного магазина.', BUSINESS_SHELF_ACCESS_REQUIRED: 'У вас нет права закупать товар для этого магазина.',
