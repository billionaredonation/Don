...
const MOBILE_OBJECT_RENDER_RADIUS_PX = 230;
const MOBILE_OBJECT_LOAD_RADIUS_PX = 620;
const MOBILE_OBJECT_REGION_RELOAD_SHIFT_PX = 240;
const MOBILE_OBJECT_RENDER_MOVE_EPSILON_PX = 18;

const MOBILE_OBJECT_RENDER_RADIUS_MIN_PERCENT = 7.5;
const MOBILE_OBJECT_RENDER_RADIUS_MAX_PERCENT = 22;
const MOBILE_OBJECT_LOAD_RADIUS_MIN_PERCENT = 18;
const MOBILE_OBJECT_LOAD_RADIUS_MAX_PERCENT = 48;
