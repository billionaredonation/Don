export const PRODUCTION_CHAINS = {
  food:Object.freeze({id:'food',factoryType:'industry_food',factoryLabel:'Пищевой комбинат',factoryIcon:'🏭',storeType:'grocery',storeLabel:'Продуктовый магазин',products:Object.freeze([{id:'grocery_apple_juice',label:'Яблочный сок',icon:'🧃'},{id:'grocery_orange_juice',label:'Апельсиновый сок',icon:'🥤'},{id:'grocery_fruit_puree',label:'Фруктовое пюре',icon:'🥫'}])}),
  fruit: Object.freeze({
