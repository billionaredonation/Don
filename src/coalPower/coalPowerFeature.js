...
function markup() {
  return `<div class="mn-coal-backdrop" data-coal-power-modal hidden><section class="mn-coal-panel">
    ...
    <main>
      ...
      <section data-coal-power-page="warehouse" hidden><h3>Склад и счёт предприятия</h3><p class="mn-coal-note">Доход от продажи электроэнергии остаётся на счёте УЭС. На личный баланс владельца он поступает только после ручного снятия.</p><div class="mn-coal-warehouse-stats"><article><small>Топливо станции</small><strong data-coal-power-warehouse-stock>0</strong></article><article><small>Счёт предприятия</small><strong data-coal-power-warehouse-cash>0 ₴</strong></article><article><small>Доход от поставок</small><strong data-coal-power-revenue>0 ₴</strong></article><article><small>Цена за 1 уголь</small><strong data-coal-power-warehouse-price>Не установлена</strong></article></div><div class="mn-coal-offer"><span><strong>⚫ Продать обыкновенный уголь</strong><small data-coal-power-offer-status>УЭС пока не принимает сырьё.</small><b>В вашем инвентаре: <em data-coal-power-player-coal>0</em></b></span><input data-coal-power-sell-quantity type="number" min="1" step="1" value="20"><button type="button" data-coal-power-sell>Продать</button></div><div class="mn-coal-owner-controls" data-coal-power-owner-controls hidden><h3>Управление владельца</h3><div class="mn-coal-procurement-switch"><span><strong data-coal-power-procurement-state>Скупка остановлена</strong><small>Цена и бюджет сохраняются после остановки.</small></span><button type="button" data-coal-power-procurement-toggle>Запустить скупку</button></div><div><label><span>Цена за единицу угля</span><input data-coal-power-buy-price type="number" min="1" step="1" value="1"></label><button type="button" data-coal-power-save-price>Сохранить цену</button></div><div><label><span>Пополнить счёт предприятия</span><input data-coal-power-budget-amount type="number" min="1" step="1" value="100000"></label><button type="button" data-coal-power-add-budget>Пополнить</button></div><div><label><span>Снять прибыль на личный баланс</span><input data-coal-power-withdraw-amount type="number" min="1" step="1" value="1000"></label><button type="button" data-coal-power-withdraw>Снять прибыль</button></div><div><label><span>Загрузить свой уголь без оплаты</span><input data-coal-power-load-quantity type="number" min="1" step="1" value="10800"></label><button type="button" data-coal-power-load>Загрузить</button></div></div></section>
