...
function applyObjectStyle(element, object, meta) {
  ...
  const customJobSize = meta.category === 'job' && ['farm_field', 'farm_station', 'mine_station', 'lumber_station', 'fruit_factory', 'metallurgy_factory', 'wood_processing_factory', 'tool_assembly_factory', 'textile_factory', 'hydro_power_plant', 'nuclear_power_plant'].includes(meta.type);
