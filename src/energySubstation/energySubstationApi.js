...
export function getSubstationError(error){
  ...
  const map={TELEGRAM_SESSION_REQUIRED:'Откройте игру через Telegram.',TELEGRAM_SESSION_INVALID:'Сессия Telegram устарела.',SUBSTATION_NOT_FOUND:'Подстанция не найдена.',SUBSTATION_ALREADY_OWNED:'У подстанции уже есть владелец.',SUBSTATION_OWNER_REQUIRED:'Действие доступно только владельцу подстанции.',SUBSTATION_AMOUNT_INVALID:'Укажите корректную сумму.',PLAYER_BALANCE_NOT_ENOUGH:'Недостаточно денег.',SUBSTATION_BALANCE_NOT_ENOUGH:'На счёте подстанции недостаточно денег.',TRANSFORMER_NOT_FOUND:'Трансформатор не найден.',TRANSFORMER_ALREADY_OWNED:'Этот трансформатор уже принадлежит другой подстанции.',TRANSFORMER_LIMIT_REACHED:'На одну подстанцию можно купить не более пяти трансформаторов.',TRANSFORMER_WRONG_CITY:'Подстанция и трансформатор должны находиться в одном городе.',SUPPLY_CONTRACT_NOT_FOUND:'Предложение электростанции уже недоступно.',SUPPLY_CONTRACT_EXISTS:'Этот контракт уже подключён.',SUPPLY_CONTRACT_REQUIRED:'Сначала примите контракт от ГЭС, АЭС или УЭС.',HOUSE_NOT_FOUND:'Дом не найден.',HOUSE_OUT_OF_RANGE:'Дом находится вне зоны этого трансформатора.',HOUSE_POWER_CONTRACT_EXISTS:'У этого дома уже есть договор электроснабжения.',TRANSFORMER_CONSUMER_LIMIT:'К трансформатору уже подключено шесть потребителей.',POWER_OFFER_NOT_FOUND:'Предложение подключения уже недоступно.',POWER_OFFER_OWNER_REQUIRED:'Принять предложение может только владелец дома.',POWER_CONNECTION_FEE_INVALID:'Подключение должно стоить не меньше 500 ₴.',POWER_TARIFF_INVALID:'Укажите корректный тариф за кВт·ч.'};
