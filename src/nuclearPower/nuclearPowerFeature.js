...
function markup() {
  return `<div class="mn-nuclear-backdrop" data-nuclear-modal hidden><section class="mn-nuclear-panel">
    ...
    <main>
      ...
      <section data-nuclear-page="contracts" hidden><h3>Государственные договоры поставки</h3><p class="mn-nuclear-note">Администрация может поставить цену 0 ₴ для бесплатного снабжения подстанции. В 00:00 выбранной даты поставка автоматически прекращается.</p><div class="mn-nuclear-contract"><input data-nuclear-target maxlength="80" placeholder="Публичный ID подстанции"><input data-nuclear-price type="number" min="0" step="0.01" value="0" placeholder="Цена за кВт·ч"><input data-nuclear-amount type="number" min="20000" max="2000000" value="20000" placeholder="Сумма договора"><input data-nuclear-end type="date"><button type="button" data-nuclear-contract-create>Предложить договор</button></div><div data-nuclear-contract-list></div></section>
    </main></section></div>`;
}
