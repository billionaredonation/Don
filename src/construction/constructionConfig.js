...
export const CONSTRUCTION_RECIPES = Object.freeze({
  construction_board: Object.freeze({ id: 'construction_board', label: 'Обрезная доска', icon: '🪚', input: 'lumber_log', inputLabel: 'Брёвна', inputIcon: '🪵', inputQty: 2, outputQty: 8, seconds: 75, wage: 70, suggestedPrice: 95 }),
