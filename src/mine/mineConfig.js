...
export const MINE_SUBTYPES = Object.freeze({
  mine_stone_common: Object.freeze({
    ...
    unlockLevel: 1, baseSellPrice: 6,
    description: 'Базовая строительная порода.',
    useLabel: 'Базовые крафты и продажа',
    specialLabel: 'Особенность: без дополнительного бонуса к крафту.',
  ...
  mine_stone_dense: Object.freeze({
    ...
    unlockLevel: 3, baseSellPrice: 11,
    description: 'Плотная порода повышенной прочности.',
    useLabel: 'Продвинутые крафты и дорогая продажа',
    specialLabel: 'Бонус: +1,5% к шансу успешного крафта.',
  ...
  mine_coal_common: Object.freeze({
    ...
    unlockLevel: 1, baseSellPrice: 18,
    description: 'Топливный уголь для огня и простых рецептов.',
    useLabel: 'Топливо, обычные крафты и продажа',
    specialLabel: 'Особенность: поддерживает огонь, но не подходит для промышленного производства.',
  ...
  mine_coal_technical: Object.freeze({
    ...
    unlockLevel: 3, baseSellPrice: 31,
    description: 'Стабильное промышленное топливо.',
    useLabel: 'Производство, технические крафты и продажа',
    specialLabel: 'Особенность: подходит для промышленных процессов вместо обычного топлива.',
  ...
  mine_metal_raw: Object.freeze({
    ...
    unlockLevel: 1, baseSellPrice: 42,
    description: 'Необработанная металлическая руда.',
    useLabel: 'Базовые металлические крафты и продажа',
    specialLabel: 'Особенность: для промышленного применения требуется переплавка.',
  ...
  mine_metal_technical: Object.freeze({
    ...
    unlockLevel: 3, baseSellPrice: 70,
    description: 'Подготовленный металл для тяжёлых работ.',
    useLabel: 'Производство, улучшения, строительство и продажа',
    specialLabel: 'Особенность: подходит для переплавки и промышленного применения.',
  ...
  mine_copper_raw: Object.freeze({
    ...
    unlockLevel: 1, baseSellPrice: 220,
    description: 'Необработанная руда с содержанием меди.',
    useLabel: 'Крафты и продажа; электроника после обработки',
    specialLabel: 'Особенность: для электроники требуется обработка и переплавка.',
  ...
  mine_copper_conductive: Object.freeze({
    ...
    unlockLevel: 3, baseSellPrice: 340,
    description: 'Богатая руда с высоким содержанием меди.',
    useLabel: 'Электроника, производство и дорогая продажа',
    specialLabel: 'Особенность: повышенная ценность для электроники и промышленных крафтов.',
