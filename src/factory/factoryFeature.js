...
import { loadFactorySnapshot, purchaseFactory, transferFruitToFactory, startFactoryBatch, finishFactoryBatch, depositFactory, withdrawFactory, setFactoryStaff, removeFactoryStaff, getFactoryError } from './factoryApi.js';
...
export function enableFactoryFeature({ root, cityId }) {
  ...
  function render() {
    const s = snapshot || {}, business = s.factory || {}, raw = s.raw || {}, products = s.products || {}, batch = s.activeBatch || null;
